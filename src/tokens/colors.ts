...
export const colors = {
  ...
  light: {
    ...
    foreground: '120 100% 50%', // Terminal green (#00ff00)
    card: '0 0% 5%', // Slightly lighter black
    cardForeground: '120 100% 50%',
    popover: '0 0% 5%',
    popoverForeground: '120 100% 50%',
    primary: '60 100% 50%', // Yellow (#ffff00)
    primaryForeground: '0 0% 0%',
    secondary: '120 100% 25%', // Darker green
    ...
    border: '120 100% 25%', // Dark green border
    input: '0 0% 10%',
    ring: '120 100% 50%',
    chart1: '120 100% 50%', // Green
    chart2: '60 100% 50%', // Yellow
    chart3: '300 100% 50%', // Magenta
    chart4: '240 100% 50%', // Blue
    chart5: '30 100% 50%', // Orange
  },
  dark: {
    background: '0 0% 0%',
